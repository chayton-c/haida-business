...
export class LineNodePojo {
  ...
  constructor(id: string, name: string, code: string, type: number, level: number, expand: boolean, lineNodePojoList: LineNodePojo[], parent: LineNodePojo, selected: boolean) {
    this.id = id;
    this.name = name;
    this.code = code;
    this.type = type;
