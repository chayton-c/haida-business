  ...
  loadDataFromServer(): void {
    this.http
      ...
      .subscribe((res) => {
        ...
        if (this.bureaus.length == 1 && !this.station.bureauId)
          this.station.bureauId = this.bureaus[0].id;
        if (this.sections.length == 1 && !this.station.sectionId)
          this.station.sectionId = this.sections[0].id;
