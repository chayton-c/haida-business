...
import { ConstructionControlPlanDetail } from '../../shared/components/construction-control-plan/detail/construction-control-plan-detail';
...
@NgModule({
  ...
  declarations: [
    ...
    exports: [KilometerPipe, ConstructionControlPlanDetail, ConstructionControlPlanPreview, ConstructionControlPlanPreviewInfo, DistanceFromRailwayPipe, ConstructionControlPlanView],
})
